...
export function Footer() {
  return (
    <footer className="bg-white border-t border-card-border pt-24 pb-12">
      <div className="container mx-auto px-4 md:px-8">
        <div className="max-w-3xl mx-auto text-center mb-24">
          <h2 className="text-4xl md:text-5xl font-extrabold text-primary-dark mb-6">Ready to finally make it stick?</h2>
          ...
          <Button size="lg" className="text-lg px-10 h-14">Build Your First Habit Plan</Button>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-card-border pt-12">
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-primary-dark">HabitPilot</span>
            </Link>
